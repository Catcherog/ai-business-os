...
- Batch 1 engineering scope is complete pending the coordinator's final push
  and external `origin/main` SHA verification. No further implementation task
  is authorized by this Goal. SCS production connection, Lumen repair, Unified
