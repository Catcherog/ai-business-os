        ...
        trace: [
          {
            ...
            status: 'SUCCEEDED',
            startedAt: new Date(Date.parse('2026-08-16T12:00:00Z')).toISOString(),
            endedAt: new Date(Date.parse('2026-08-16T12:00:01Z')).toISOString(),
            durationMs: 1000,
            metadata: { leadId: 'lead_err', governanceDecision: 'APPROVE' },
          },
          {
            processId: 'proc_err_1',
            stage: 'CREATIVE_PRODUCTION',
            status: 'FAILED',
            startedAt: new Date(Date.parse('2026-08-16T12:00:01Z')).toISOString(),
            endedAt: new Date(Date.parse('2026-08-16T12:00:03Z')).toISOString(),
            durationMs: 2000,
            error: {
              code: 'CREATIVE_GENERATION_FAILED',
